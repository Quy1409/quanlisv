<?php
  ...
  session_start();
  // thực hiện chuyển hướng  giao diện người dùng
  if (isset($_SESSION['uid']) && (trim($_SESSION['uid']) != '')) {
    #-- kiểm tra vai trò/phân quyền của người dùng --
    switch ($_SESSION['urole']) {
        #-- phân quyền 'quản trị viên' --
      case 'qtv':
        require('includes/admin_ui/admin_ui.php');
        break;

      case 'gv':
        require('includes/giangvien_ui/giangvien_ui.php');
        break;

      case 'sv':
        require('includes/sinhvien_ui/sinhvien_ui.php');
        break;
