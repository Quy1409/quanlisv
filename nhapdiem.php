  ...
  <div class="row breadcrumb-div">
    <div class="col-md-6">
      <ul class="breadcrumb">
        ...
        <li class="active">Quản lí điểm sinh viên</li>
...
<!-- /.container-fluid --> 
  ...
  if(isset($_POST['submit'])){
    $insert="
      INSERT INTO tbl_diemhocphan
      VALUES('" . $_POST['msv'] . "','" . $_POST['mhp'] . "','" . $_POST['A'] . "','" . $_POST['B'] . "','" . $_POST['C'] . "');
    ";
            ...
            <div class="panel-body">
              <form method="post">
                ...
                <div class="form-group has-success">
                  ...
                  <div class="">
                    <input type="text" name="mhp" required="required" class="form-control" id="success">
                ...
                <div class="form-group has-success">
                  ...
                  <div class="">
                    <input type="text" name="B" class="form-control" required="required" id="success">
                ...
                <div class="form-group has-success">
                  ...
                  <div class="">
                    <input type="text" name="C" class="form-control" required="required" id="success">
                    <span class="help-block"></span>
                  </div>
                </div>
